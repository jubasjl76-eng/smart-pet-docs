...
| 20 — Traffic control, caching & resilience | 🔨 in progress — **Redis wired live** (backend#65, sensors#17, terraform#17), **rate-limit stack** (backend#66), **leader lock** (backend#67), **idempotency store** (backend#68). |
| 21 | 📋 planned |
