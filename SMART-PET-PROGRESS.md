...
**Phase 15 — remaining:** firmware crash path + a backend consumer; CI — create a Sentry release + upload source maps on `v*` (`smart-pet-ci` + the Vite/Next/EAS build configs). Needs a Sentry org + a DSN per project to go live (ops step — `OPERATOR-ACTIONS.md` A1/A2).
| 16–21 | 📋 planned |
