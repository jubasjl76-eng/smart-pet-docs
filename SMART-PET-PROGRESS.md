...
| 19 — Firmware hardening & HIL | 🔨 in progress — **time trust** (sdk#15), **brown-out resilience** (sdk#16), **fleet kill switch** (sdk#17 + backend#62 + dashboard#25): retained `_control` safe-mode topic, halt/resume API, "Halt fleet" button. |
| 20–21 | 📋 planned |
