...
| 19 — Firmware hardening & HIL | 🔨 in progress — **time trust** (sdk#15) + **brown-out resilience** (sdk#16): NVS last-known-good clock, `timeTrusted()` schedule gate, atomic CRC-checked config with factory-default fallback, RTC brown-out counter. |
| 20–21 | 📋 planned |
