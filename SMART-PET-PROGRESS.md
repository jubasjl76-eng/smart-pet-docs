...
| 21 — High availability, DR & load validation | 🔨 in progress — **EMQX cluster depth** (terraform#20, backend#75), **RDS read replica + read routing** (terraform#21, backend#76), **OTA CDN hardening** (sdk#21, backend#77, terraform#22). |
