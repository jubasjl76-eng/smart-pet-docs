...
| 19 — Firmware hardening & HIL | 🔨 in progress — SDK: **time trust** (sdk#15), **brown-out resilience** (sdk#16), **fleet kill switch** (sdk#17 + backend#62 + dashboard#25), **memory guards** (sdk#18). |
| 20–21 | 📋 planned |
