...
**Phase 17 — remaining:** firmware GoogleTest + coverage + sanitisers + Wokwi command-loop + contract test; Maestro + RNTL for `smart-pet-app`; fold the two web `e2e.yml`s into a `smart-pet-ci` reusable.
