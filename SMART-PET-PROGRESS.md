...
**Phase 18 — next:** AWS posture (Security Hub / GuardDuty / scoped OIDC role) once the account is live; firmware static (cppcheck / clang-tidy / Flawfinder) + the Secure Boot / Flash Encryption design doc (rollout → Phase 19).
