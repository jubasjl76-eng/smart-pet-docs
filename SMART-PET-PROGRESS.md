...
| 20 — Traffic control, caching & resilience | 🔨 in progress — **Redis wired live** (backend#65, sensors#17, terraform#17), **rate-limit stack** (backend#66), **leader lock** (backend#67), **idempotency store** (backend#68), **SSE fan-out** (backend#69), **circuit breakers** (backend#70), **job queue + outbox** (backend#71), **table partitioning** (backend#72), **feature-flag mechanism** (backend#73, dashboard#27), **RDS Proxy + pool tuning** (backend#74, terraform#18), **MQTT broker limits** (terraform#19). |
| 21 | 📋 planned |
